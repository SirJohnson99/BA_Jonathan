...
Im Folgenden werden die Ergebnisse der Schallfeldmessung des DML-Lautsprechers 70x44 cm dargestellt und ausgewertet. Die Messung erfolgte im Freifeldraum der Hochschule mit einer horizontalen Winkelauflösung von \SI{15}{\degree} bei einem Messabstand von 1 m. Zur vermessung des Gesammtschalldruck pegels wurde die LabVIEW Vi Sound Level Meter verwendet, die Mikrofonempflindlichkeit wurde eingestellt und über den Lautsprecher ein Weißes Rauschen abgespielt welches aufgenommen und über zehn Sekunden Gemittelt wurde.

\textbf{Abbildung SOund Level Meter}


Die Abbildung zeigt das Frontpanel der Sound Level Meter VI, zu erkennen ist die Mikrofonempfindlichkeit des iSEMcon Mikrofons und die Mittelung auf Zehn Sekunden. 
...
\textbf{Abbildung Bose Lausprecher}

Abbildung zeigt den Boselautsprecher welcher als Fullrangesystem mit Hoch-, Mitten- und Tieftöner ausgestattet ist. 


Zum Vermessen der Lautsprecher wurde das in Kapitel 3.4.2 beschriebene LabVIEW VI verwendet. 


\textbf{Abbildung Frontpanel LabVIEW} 


In Abbildung wir das Frontpanel währen einer messung gezeigt, zu erkennen ist die Anregeung mittels Weißem Rauschen im Graphen Oben Links. Das Mikrofon und referenzsignal werden Obenrechts angezeigt. In der Mitte des Frontpanels wird die FRF Übertragungsfunktion und die zugehörige Kohärenz Graphisch dargestellt. Unten wird der Schalldruckpegel über der Frequenz dargestellt. 
