...
Dementsprechen ist eine Seitenlänge eines DML aus KAPA Line von mindestens 20 cm nötig um eine Grundfrequenz von 20Hz gut wiedergeben zu können. Da die KAPA Platten in einer Größe von 1m x 0,7m gelifert werden wurde sich für fir größe der Platten mit den Seitenlängen 0,44 m x 0,7 m entschieden, da diese das Seitenverhältniss erfüllen und die anfertigung effektiv gestaltet. 
...
Mit der Allegmeinen Systemauslegung ist vorallem das Zusammenspiel der Elektrsichen Komponenten, also des Exciters und der Stereoanlage gemeint. Hierbei stellen sich zwei Fragen in den vordergrund, wie viele Exciter pro Platte verwendet werden und wie die verdrathung der Exciter am sinnvollsten ist?
Da die Anzahl der Exciter sowhol auf die Gesamt Impedanz des systems als auch auf die Abstrahlleistung eionfluss hat \cite{Bai2001}.

Die Verwendung einenes Einzelnen Exciters pro Platte ist die einfachste umsetzung. Die Impedanz des Systems entspricht der des Exciters von 4 $\Omega$ \cite{DaytonAudio2024}, was dem Anhang A zu entnehmen ist. Die Verwendete Stereoanlage kann Lautsprecher von 4-16 $\Omega$ versorgen, siehe Anhang B. Dennoch sollte berücksichtigt werden das die Exciter bei voller leistung auf dauer beschädigt werden können. Zudem kann die Platzierung des Exciters ungünstig für die Modenanregung sein. 

Die verwendung von Zwei Excitern pro Platte mit Symetrische anordnung hat vor und nachteile. Ein vorteil der Symetrischen Positionierung ist die theoretische Verdoppelung des Schalldruckpegels bei kohärenter Anregung \cite{Moeser2005}. Des weiteren wird die Platte durch die Symetrsiche Anregung Gleichmäßíg belastet und es entstehen keine Torsionskräfte \cite{Moeser2005}. Doch durch eine Symetrische Anregung können nicht alle Moden angeregt werden was zu starken Schwankungen im Frequnezband führen kann \cite{Pueo2009}. Da diese arbeit jedoch eine Gute Abstrahlung auf allen Frequenzen anstrebt ist eine Symetrische anordnung unvorteilhaft. 

Bei einem zwei Exciter System mit Asymetrischer Positionierung können mehrere Eigenmoden der Platte anregen werden was zu einer Gelichmäßigen Abstrahlung im gesamten Frequnezband führt \cite{Zenker2019}. Daher bietet sich ein Zwei Exciter System mit Asymetrischer anordnung als vielversprechernd an.  

Bei der Verkabelung des Systems gibt es die entsdheidung zwischen Reihen und Parallel schaltung. Bei der reichenschasltung der Exciter addiert sich die Impedanz was bei zwei Exitern zu einer verdoppelung der gesamtimpedanz fürht. Eine Verdoppelung der gesamtimpedanz auf 8 $\Omega$ kann die Langlebigkeit der Exciter erhöhen da diese Bei voller last weniger Thermischer belastung ausgelegt sind. 
Bei einer prallel schaltung der Exciter verändert sich die gesamtimpedanz des Systems nicht, was bei Langer verwendung zu schäden durch hohe Thermsiche belastung fürhen kann. Zudem kann eine zu Geringe Impedanz zu schäden an der Seteoanlage führen.
...
Die KAPA Line Sandwichplattenw erden eine Größe von 0,7 m x 0,44 m haben da diese Seitenlängen in das Verhältniss passt und einfach herzustellen sind. Damit sind diese Größer als im Graphen \ref{fig:seitenlaenge_frequenz} aufgezeit, diese größe wurde aus dem grund gewählt um eine gute Tiefton wiedergabe zu gewährleisten und die Exciter nicht zu nahe aneinader platziert werden. 
