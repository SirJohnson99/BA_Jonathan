...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/frequenzgang_70x44.png}
	\caption{Frequenzgang DML 70x44 cm}
	\label{fig:frequenzgang_70x44}
\end{figure}

Im Tieftonbereich (30--100\,Hz) startet die blaue Kurve mit einem auffälligen Peak bei ca.\,30\,Hz ($\approx$\,100\,dB), fällt dann aber deutlich auf ca.\,75\,dB bei $\approx$\,80\,Hz ab -- eine Senke von rund 25\,dB. Im Mittenbereich (100--600\,Hz) erholt sie sich und erreicht zwischen 400--600\,Hz ein Maximum von ca.\,98\,dB, zeigt dabei aber deutliche Welligkeit. Oberhalb von 1\,kHz nimmt die Varianz stark zu, mit Schwankungen von $\pm$\,10\,dB, wobei das Gesamtniveau bei ca.\,75--85\,dB liegt. Im Hochton (ab $\approx$\,5\,kHz) bleibt sie im Mittel etwas über der roten Kurve, ist aber sehr unruhig.

Die grüne Kurve ist im gesamten Verlauf deutlich \textbf{glatter}. Im Tiefton (30--100\,Hz) liegt sie stabil bei ca.\,87--92\,dB ohne den starken Einbruch der blauen Kurve. Im Mittenbereich (100--600\,Hz) verläuft sie gleichmäßig um 85--90\,dB -- ohne ausgeprägte Peaks. Oberhalb von 1\,kHz zeigt auch sie zunehmende Schwankungen, diese sind aber tendenziell weniger extrem als bei Blau. Im Hochton oberhalb von 5\,kHz liegt sie auf vergleichbarem Niveau wie die blaue Kurve.

Der Bose zeigt einen relativ gleichmäßigen Verlauf von ca.\,88--92\,dB bis etwa 500\,Hz. Ab ca.\,1--2\,kHz fällt die Kurve allerdings merklich ab und zeigt ab 3\,kHz starke Einbrüche bis unter 50\,dB. Oberhalb von 5\,kHz ist der Bose den beiden DML-Positionen deutlich unterlegen. Dies deutet auf ein begrenztes Hochtonvermögen oder eine ungünstige Abstrahlcharakteristik in der Messposition hin.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/frequenzgang_100x70.png}
	\caption{Frequenzgang DML 100x70 cm}
	\label{fig:frequenzgang_100x70}
\end{figure}

Blau – „Mittelwert 1m" (Exciter-Position 1)
Im Tiefton (30–100 Hz) startet die blaue Kurve bei ca. 91 dB und verläuft relativ stabil um 85–90 dB – deutlich gleichmäßiger als bei der 70×44-Platte, wo ein 25-dB-Einbruch auftrat. Im Mittenbereich (100–600 Hz) liegt sie bei 88–95 dB mit moderater Welligkeit. Bei ca. 1 kHz tritt ein ausgeprägter Peak von ~100 dB auf. Oberhalb von 1 kHz schwankt sie stark (70–90 dB), bleibt aber im Mittel bei ~80 dB. Im Hochton (>5 kHz) ist sie unruhig, hält sich aber auf 70–85 dB.

Grün – „Mittelwerte 1m Skript" (Exciter-Position 2)
Die grüne Kurve zeigt im Tiefton einen niedrigeren Start (~80 dB bei 30 Hz) und eine Senke um 60 Hz auf ca. 79 dB. Im Mittenbereich (100–600 Hz) verläuft sie mit ca. 85–88 dB erneut glatter als die blaue Kurve, ohne den 1-kHz-Peak. Im Hochton ist sie vergleichbar mit Blau, tendenziell etwas weniger extrem in den Ausschlägen.

Rot – Bose (Referenz)
Der Bose startet im Tiefton stark (~95 dB bei 30 Hz), zeigt aber einen deutlichen Einbruch auf ~73 dB bei ca. 100 Hz. Nach einer Erholung im Mittenbereich (85–92 dB) fällt er ab 2–3 kHz drastisch ab, mit Einbrüchen unter 50 dB. Im Hochton ist er den DML-Varianten klar unterlegen.



\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/frequenzgang_vergleich.png}
