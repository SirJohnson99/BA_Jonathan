...
Die Legende welche in den Abbildungen \ref{fig:eigenmoden_07m} \ref{fig:eigenmoden_1m} auf der Rechten seite zu sehen ist zeigt an das die Dunklen Violetten bereiche eine Größere verschiebung aufweißen, je heller die Platte desto weniger verschiebung. 

Die Verschiebung der Platte bei den Frequenzen wird in der auswertung genutzt um die Positionen der Exciter zu bestimmten. Hierfür wurden die Daten der Simulation in abhängigkeit zu einer durch die Mitte der Platte verlaufenden Ebene Exportiert. Dabei wurde ein Raster mit 11mm großen abständen über die Platte gelegt. Anschließend wurden die Daten in einem Phytonskrip anhand ihrer Verschiebung ausgewertet und die Punkte im Raster ausgewertet ahnand ihrer Verschiebung. Dabei wurden Punkte an denen eine Geringe verschiebung auftritt als Gut und dort wo eine Hohe verschiebung auftrit als schlecht bewertet. Anhand dieser Bewertung wurden die Idealen Exiterpositionen bestimmt.    
...
Ziel des Versuchs ist die objektive Vermessung des DML-Lautsprechers sowie die Erfassung zentraler akustischer Kenngrößen. Hierzu zählen insbesondere die Übertragungsfunktion sowie der frequenzabhängige Schalldruckpegel. Der Frequenzgang der Übertragungsfunktion beschreibt das Verhältnis zwischen dem vom Lautsprecher abgestrahlten Signal und dem zugeführten elektrischen Referenzsignal des Verstärkers. Mittels Übertragungsfunktion, welche in Kapitel 2.3 beschrieben wurde, wird das Übertragungsverhalten des Gesamtsystems charakterisiert.

Der Versuchsaufbau verfolgt dabei zwei Ziele, die Messung des Schalldruckpegels über der Frequenz, dafür wird ein Messmikrofon einen Meter vor der Mitte der Platte aufgestellt, während der Lautsprecher mit einem weißen Rauschen angeregt wird.
Das zweite Ziel ist die Erfassung des abgestrahlten Schallfeldes, da DML-Lautsprecher einen wesentlich größeren Abstrahlwinkel als herkömmliche Lautsprecher haben. Für diesen Aufbau wird das Messmikrofon genau wie beim ersten Versuch in einem Abstand von 1 m auf Höhe der DML-Mitte positioniert, dann wird in 10-Grad-Abständen an 36 Positionen eine Messung vorgenommen, um die Abstrahlcharakteristik rund um den Lautsprecher zu messen.
Jede Messung wird dreimal vorgenommen und anschließend werden die Messergebnisse gemittelt, um mögliche Peaks oder Messunsicherheiten zu minimieren. 
