...
Die Verschiebung der Platte bei den Frequenzen wird in der Auswertung genutzt, um die Positionen der Exciter zu bestimmen. Hierfür wurden die Daten der Simulation in Abhängigkeit zu einer durch die Mitte der Platte verlaufenden Ebene exportiert. Dabei wurde ein Raster mit 11 mm großen Abständen über die Platte gelegt. Anschließend wurden die Daten in einem Python-Skript anhand ihrer Verschiebung ausgewertet. Dabei wurden Punkte, an denen eine geringe Verschiebung auftritt, als gut und dort, wo eine hohe Verschiebung auftritt, als schlecht bewertet. Anhand dieser Bewertung wurden die idealen Exciterpositionen bestimmt.    
...
In diesem Kapitel wird der Versuchsaufbau zur Vermessung der akustischen Eigenschaften der DML-Lautsprecher beschrieben, realisiert und durchgeführt. Um sicherzustellen, dass bei der Messung ausschließlich die akustischen Eigenschaften des Lautsprechers erfasst werden und Einflüsse des Messraums minimiert werden, erfolgt die Durchführung im Freifeldraum. Ein Freifeldraum ist ein reflexionsarmer Raum, dessen Wände, Decke und Boden mit schallabsorbierenden Materialien ausgestattet sind, sodass auftreffende Schallwellen nahezu vollständig absorbiert werden.

Zur Durchführung der Messungen sowie zur Signalverarbeitung wird die Software LabVIEW der Firma National Instruments eingesetzt. Mit dieser werden sowohl die Testsignale generiert als auch die aufgenommenen Messdaten erfasst und weiterverarbeitet, um die Übertragungsfunktion sowie den Schalldruckpegel frequenzabhängig auszuwerten. Das Weiße Rauschen wird über die Output Karte NI PIX-6733 an den Equalizer und den Audiovorverstärker ausgegeben. Die Einstellungen des Equalizers und des Audioverstärkers sind während jedes messung unverändert gewesen und können in der Abbildung X im Anhang Y entnommen werden, der Equalizer hat während der messungen keine Signalveränderung vorgenommen.

Der Versuchsaufbau verfolgt zwei Ziele um die Akustischen eigenschaften des DML zu Bewerten. Das erste Ziel ist die Messung des Schalldruckpegels über der Frequenz, dafür wird ein Messmikrofon einen Meter vor der Mitte der Platte aufgestellt, während der Lautsprecher mit einem weißen Rauschen angeregt wird.
...
Das zweite Ziel ist die Erfassung des abgestrahlten Schallfeldes, da DML-Lautsprecher einen wesentlich größeren Abstrahlwinkel als herkömmliche Lautsprecher haben. Für diesen Aufbau wird das Messmikrofon genau wie beim ersten Versuch in einem Abstand von 1 m auf Höhe der DML-Mitte positioniert und an definierten stellen um den Lautsprecher Gemessen um die Abstrahlcharakteristik rund um den Lautsprecher zu erfassen. Der Lautsprecher ist in diesem Fall an einer Schnur welche in der Mitte der mit einer Öse welche in den PUR Hartschaum der Platte geklebt drehbar aufgehängt. an der Unerseite der Platte sind an beiden Ecken schnüre an einer Wasserwage befestigt, die Wasserwage dient als Gewicht um die Platte in der Gedrehten Position zu halten. Am boden sind mit Klebeband Markierungden der messpunkte. Das Drehen der Platte ist ein einfacher aufbau welcher gleichzeitig mögliche Messverfälschungen des Raums durch die Positionsänderung des Mikrofons minimiert. 



Die Abbildung zeigt den DML Lautsprecher welcher an der oberseite Mittig hängt und an der unterseite Mit zwei schnüren zum boden mit der Wasserwage befestigt ist. 
...
Abbildung Messaufbau im Freifeldraum mit Drehbarer Platte
