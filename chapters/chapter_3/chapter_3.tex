...
Daraus ergibt sich die kurze Seitenlänge im Bereich 20 Hz -- 150 Hz, gezeigt in Abbildung \ref{fig:seitenlaenge_frequenz}:
...
% TODO: Abbildung Platte 70x44 und 100x70 einfügen

% TODO: Diskussion der Ergebnisse ergänzen
...
Die Abbildung \ref{fig:schallfeld_messung} zeigt den DML-Lautsprecher, welcher an der Oberseite mittig hängt und an der Unterseite mit zwei Schnüren zum Boden mit der Wasserwaage befestigt ist. Zur Ausrichtung der Platte wurde ein Laser verwendet, der grüne Laser ist auf der Platte und am Messmikrofon zu erkennen. 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pictures/Schallfeld_Absolut.png}
	\caption{Schallfeld absolut}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pictures/Schallfeld_Normiert.png}
	\caption{Schallfeld normiert}
