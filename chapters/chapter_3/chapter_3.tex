...
Dementsprechend wird die Plattengröße anhand des Seitenlängenverhältnisses 1:1,618 sowie der Grundfrequenz bestimmt. Die Grundfrequenz kann dabei mit folgender Formel für Rechteckige Platten näherungsweise bestimmt werden: 
...
In Abbildung \ref{fig:seitenlaenge_frequenz} wurde mit hilfe der Berechneten Biegesteifigkeit der Sandwichplatten und den Formeln 3.1 bis 3.3 eine Grafig erstellt welche die Kurze seitenlänge über der Frequnez in einem Frequenzband von 20Hz bis 150Hz datstellt. zu erkennen ist das für eine grundfrequnez von 20Hz eine KAPA Line Platte mit der seitenlänge von ca. 20 cm ausreicht. Eine KAPA Graph Platte benötigt nur eine Seitenlänge von ca. 11 cm. Die Seitenlängen sind die Jeweils kurzen des Rechtecks mit dem Seitenverhältnis 1:1,61. 
Dementsprechen ist eine Seitenlänge eines DML aus KAPA Line von mindestens 20 cm nötig um eine Grundfrequenz von 20Hz gut wiedergeben zu können. 
...
Zusammenspiel Stereoanlage und auslegung der Exciter anzahl. 
...
Plattengröße größer als in dem Graphen damit die Exciter nicht zu nahe aneinander sind. zudem ist die Platte leichter herzustellen. 
