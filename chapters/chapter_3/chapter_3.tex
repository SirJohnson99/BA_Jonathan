...
Bei der Simulation zur Entwicklung des DML wurde sich für eine Eigenfrequenz analyse der verwendeten Platten und gegen die Simulation eines Exciters als Federmasse system welches die Platte anregt und der Abgestrahlte schalldruck berechnet wird entschieden. Ausschlag gebend für diese entscheidung ist vorallem der Unterschied in der Komplexität der beiden Aufbauten da eine Eigenfrequenzanalys einfacher und Rechenleistungs ärmer ist.

Bei der Eigenfrequenzanalyse  wurden zwei KAPA Line Platten mit den Größen 1 m x 0.7 m \& 0.7 m x 0.44 m auf deren Eigenfrequenzen untersucht. Dabei wurden die Größendaten und die Eigenschaften des Materials im Modelbuilder eingegeben. Die Platte wurde in der Simulation als eine Monolitische Platte angenommen und nicht als Sandwichbauweise. Für diesen aufbau wurde sich aufgrund von geringerer Komplexität des modells und fehlender Materialeigenschaften entschieden. Da im KAPA Line datenblatt Anhang C nur die Materialeigenschaften als Sandwichbauweise und nicht der einzlnen Materialien, Deckschicht und Kern angegeben wurden. Anschließend wurde eine Eigenfrequnezstudie angelegt bei der die Platten angeregt werden von 0 Hz bis 400 Eigenmoden der Platten Berechnet wurden. Die anzahl der Eigenmoden wurde gewählt da diese für beide Platten die 1000Hz überschritten haben und die Moden dichte mit zunehmender Frequenz zunimmt \cite{Cremer1996}. Die Platte ist dabei Frei gelagert da sich für eine Freihängende Lagerung im Konzeptentscheid entschieden wurde. 
...
Die Berechneten eigenmoden der Platten weisen verschiedene Muster auf der Platte auf, diese zeigen die Bewegung der Platte bei der Eigenfrequenz an. Die bilder zeigen die Muster der Simulierten eigenmoden bei 50Hz, 150Hz, 300Hz, 500Hz, 800Hz und 1000Hz an.  
...
Der Versuchsaufbau verfolgt dabei zwei Ziele, die Messung des Schalldruckpegels über der Frequenz, dafür wird  ein Messmikrofon einen Meter vor der Mitte der Platte aufgestellt, währen der Lautsprecher mit einem Weißen rauschen Angeregt wird.
Das zweite ziel ist die erfassung des Abgestrahlten Schallfeldes, da DML Lautsprecher einen wesentlich größeren abstrahlwinkel als herkömmliche Lautsprecher haben. Für diesen aufbau wird das Messikrofon genau wie beim ersten versuch in einem abstand von 1m auf höhe der DML mitte positioniert, dann wird in 10 grad abständen an 36 Positionen eine Messung vorgenommen um die Abstrahlcharakteristik rund um den Lautsprecher zu messen.
Jede Messung wird drei mal vorgenommen und anschließend werden die Messergebnisse gemittelt um mögliche Peaks oder Messunsicherheiten zu minimieren. 
