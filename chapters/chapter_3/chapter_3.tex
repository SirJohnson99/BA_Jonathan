...
Die numerische Simulation mechanischer und akustischer Systeme mittels COMSOL Multiphysics basiert auf der Finite-Elemente-Methode (FEM), einem seit Jahrzehnten etablierten Standard in der Ingenieurwissenschaft zur Lösung partieller Differentialgleichungen [COMSOL Multiphysics - Website, 2024]. Die FEM ermöglicht die Analyse komplexer Geometrien durch Diskretisierung des kontinuierlichen Problems in eine endliche Anzahl von Elementen, wobei die Lösung in jedem Element durch Formfunktionen approximiert wird [Petritsch TU Graz]. COMSOL Multiphysics ist eine Simulationsplattform, die vollständig gekoppelte Multiphysik- und Einzelphysik-Modellierungsfunktionen bietet, wobei der Model Builder alle Schritte des Modellierungs-Workflows umfasst, von der Definition von Geometrien und Materialeigenschaften über die Physik-Beschreibung bis hin zur Durchführung von Berechnungen und der Auswertung der Ergebnisse [COMSOL Multiphysics - Website, 2024].

Für die Simulation von DML-Lautsprechersystemen ist das Acoustics Module von zentraler Bedeutung, welches sowohl die Modellierung der Strukturschwingungen der Panel-Membran als auch der daraus resultierenden Schallabstrahlung ermöglicht [COMSOL Acoustics Module, 2024]. Das Acoustics Module enthält das Solid Mechanics Interface unter dem Zweig \glqq Elastic Waves\grqq{}, welches speziell für die Analyse elastischer Wellen in Festkörpern konzipiert ist und die vollständige Elastodynamik repräsentiert [COMSOL Acoustics Module User's Guide, 2024, S. 304-314; COMSOL Blog - ASI, 2024]. Dieses Interface löst die dynamischen Navier-Gleichungen im Frequenzbereich und ermöglicht die Berechnung von Verschiebungsfeldern, Spannungen und Dehnungen in schwingenden Strukturen. Für die Analyse von Platten und Schalen, wie sie bei DML-Panels zum Einsatz kommen, stehen im Solid Mechanics Interface spezielle Formulierungen zur Verfügung, welche die Biegesteifigkeit und das Schwingungsverhalten dünnwandiger Strukturen präzise abbilden [COMSOL Acoustics Module User's Guide, 2024, S. 656-661]. Das Acoustics Module umfasst eine Vielzahl von Funktionen zur Akustik-Struktur-Interaktion, wobei dedizierte Multiphysik-Kopplungen existieren, um Fluid-, Festkörper- und poröse Domänen zu koppeln und vollständig gekoppelte FEM-Modelle zu erstellen [COMSOL Acoustics Module, 2024]. Diese Zwei-Wege-Kopplung berücksichtigt sowohl die Anregung der Struktur durch akustische Druckfelder als auch die Schallabstrahlung durch strukturelle Schwingungen.
...
\begin{enumerate}
    ...
    \item 2. 42\% außermittig von den Seiten Längen 
    \item 3. Frei gewählte Positionen 
\end{enumerate}
