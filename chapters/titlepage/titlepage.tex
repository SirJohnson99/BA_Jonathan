...
\begin{center}
\textbf{\Huge Entwicklung eines Flach-Lautsprechers mittels Körperschallwandler}\\ 
...
Datum der Ausgabe:& 3 Monate vorher	\\											% Ausgabedatum
Datum der Einreichung:&April 24, 2026 	\\										%Abgabedatum
\end{tabular}
\label{default}
\end{flushleft}
\end{table}%
