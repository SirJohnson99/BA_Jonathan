...
Die VDI-Richtlinie-2221 Entwicklung technischer Produkte und Systeme stellt den deutschen Standard für systematische Produktentwicklung dar [VDI 2221 Blatt 1, 2019]. Die Entwicklung erfolg in Strukturierten, Nachvollziehbaren schritten. Die Richtlinie gliedert den Entwicklungsprozess in sieben zentrale Phasen [VDI 2221 Blatt 1, 2019, S. 11-15]:
\begin{enumerate}
...
\end{enumerate}
Ein zentrales Prinzip ist das iterative Arbeiten: Die Phasen werden nicht starr sequentiell durchlaufen, sondern durch zyklisches Pendeln zwischen Zielen, Anforderungen und Ergebnissen kontinuierlich optimiert [VDI 2221 Blatt 1, 2019, S. 10]. Dies ermöglicht frühe Fehlervermeidung und flexible Anpassung an neue Erkenntnisse [Pahl et al. 2013, S. 129-131].
Für diese Arbeit strukturiert die VDI-2221 den Entwicklungsprozess des Flach-Lautsprechers: Anforderungsdefinition (Kap. 3.1), Konzeptentwicklung (Kap. 3.2), Simulation und Optimierung (Kap. 3.3-3.5), sowie Prototypenbau und Dokumentation (Kap. 4.1). Die Kombination mit dem PDCA-Zyklus welcher im folgenden Kapitel Besschrieben wird  gewährleistet kontinuierliche Verbesserung innerhalb der Phasen [Pahl et al. 2013, S. 135].
